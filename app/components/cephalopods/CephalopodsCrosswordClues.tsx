...
interface CephalopodsCrosswordCluesProps {
  crosswordAnswers: {
    tentacle: string;
    octopus: string;
    curing: string;
...
export default function CephalopodsCrosswordClues({ crosswordAnswers, onReset }: CephalopodsCrosswordCluesProps) {
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  ...
                  <span className="font-special-elite text-base text-black" style={getStrikethroughStyle(isClueCorrect('octopus'))}>
                    Eight-armed sea creature
                    {isClueCorrect('octopus') && (
                ...
                <div className="flex items-start">
                  ...
                  <span className="font-special-elite text-base text-black" style={getStrikethroughStyle(isClueCorrect('clam'))}>
                    Burrowing two-shelled mollusk
                    {isClueCorrect('clam') && (
                      <div className="scribble-svg">
                        <svg width="100%" height="20" viewBox="0 0 300 20">
                          <line 
                ...
                <div className="flex items-start">
                  ...
                  <span className="font-special-elite text-base text-black" style={getStrikethroughStyle(isClueCorrect('salmon'))}>
                    Migratory pink-fleshed fish
                    {isClueCorrect('salmon') && (
                      <div className="scribble-svg">
                        <svg width="100%" height="20" viewBox="0 0 300 20">
                          <line 
                            className="scribble-line animate"
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  ...
                  <span className="font-special-elite text-base text-black" style={getStrikethroughStyle(isClueCorrect('tentacle'))}>
                    Long arm of a cephalopod
                    {isClueCorrect('tentacle') && (
                      <div className="scribble-svg">
                        <svg width="100%" height="20" viewBox="0 0 300 20">
                          <line 
                            className="scribble-line animate"
                ...
                <div className="flex items-start">
                  ...
                  <span className="font-special-elite text-base text-black" style={getStrikethroughStyle(isClueCorrect('curing'))}>
                    Preserving by salt or smoke
                    {isClueCorrect('curing') && (
                      <div className="scribble-svg">
                        <svg width="100%" height="20" viewBox="0 0 300 20">
                          <line 
                            className="scribble-line animate"
                ...
                <div className="flex items-start">
                  ...
                  <span className="font-special-elite text-base text-black" style={getStrikethroughStyle(isClueCorrect('gills'))}>
                    Fish breathing organs
                    {isClueCorrect('gills') && (
                      <div className="scribble-svg">
                        <svg width="100%" height="20" viewBox="0 0 300 20">
                          <line 
          ...
          {checkedAnswers && (
            <div className="mt-6 text-center">
              <span className="font-special-elite font-bold text-lg text-black">
                Score: {
                  [
                    crosswordAnswers.tentacle === 'TENTACLE',
                    crosswordAnswers.octopus === 'OCTOPUS',
                    crosswordAnswers.curing === 'CURING',
                    crosswordAnswers.clam === 'CLAM',
                    crosswordAnswers.gills === 'GILLS',
                    crosswordAnswers.salmon === 'SALMON'
